...
export default async function BookingPage({ searchParams }: BookingPageProps) {
  ...
  return <><PageHero eyebrow="RESERVATION" title="把想住的日子，告訴我們。" description="Ohori Stay 每次只接待一組、最多 6 人。填寫需求後，我們會確認日期、房況與完整費用。" index="06" />
    <section className="booking-calendar-section section-space"><div className="section-shell"><div className="section-heading-row"><div><p className="eyebrow">AVAILABILITY</p><h2>查看目前房況</h2></div><p className="muted-copy">已確認日期會顯示為已訂房；點選可入住日期，可帶入下方申請表。</p></div><AvailabilityCalendar compact /></div></section>
