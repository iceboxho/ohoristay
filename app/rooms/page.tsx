...
import { brand, stay } from "@/lib/site-data";
...
export default function RoomsPage() {
  return (
    <>
      <PageHero eyebrow="THE STAY" title="一整套，只留給同行的你們。" description={`${brand.name}是整套 2LDK 公寓，不與陌生旅客共享。一次僅接待一組、最多 6 人，適合家庭與朋友旅行。`} index="02" />
